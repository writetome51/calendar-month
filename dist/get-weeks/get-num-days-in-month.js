...
export class GetNumDaysInMonth {
    ...
    year }) {
        ...
        if (month === 13) {
            ...
            this.__checkIfLeapYear(year);
        return this.__dayCountsForEachMonth[month - 1];
    }
    static __checkIfLeapYear(year) {
...
GetNumDaysInMonth.__dayCountsForEachMonth = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
GetNumDaysInMonth.__checkedYear = 0;
